...
object DataSource {
    ...
    private val cats = listOf(
        AnimalSection.Animal("Cat1", "https://icatcare.org/app/uploads/2018/07/Thinking-of-getting-a-cat.png"),
    ...
    private val pikas = listOf(
        AnimalSection.Animal("Pika1", "https://i.ytimg.com/vi/eQ0XSifoNOI/maxresdefault.jpg"),
        AnimalSection.Animal(
            "Pika2",
    ...
    private val titlesToAnimals: HashMap<String, List<AnimalSection.Animal>> = hashMapOf(
        titles[0] to cats,
        titles[1] to pandas,
    ...
    fun createSections(numberOfSections: Int, itemsPerSection: Int): MutableList<AnimalSection> {
        ...
        for (i in 0 until numberOfSections) {
            val animals = mutableListOf<AnimalSection.Animal>()
